...
export default function Hero() {
    ...
    return (
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-background-light dark:bg-background-dark transition-colors duration-500 px-4 sm:px-6 lg:px-8">
            {/* Фоновый градиент для мобильных */}
            {/* Фоновые декоративные элементы - адаптивные */}
            ...
            <div className="relative z-10 container mx-auto text-center max-w-7xl mt-[70px]">
                <div className="max-w-4xl mx-auto">
                    ...
                    {/* Главный заголовок */}
                    <h1 className="text-3xl font-bold mb-4 tracking-tight text-text-light dark:text-text-dark transition-colors duration-500 sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl"
                        data-aos="fade-up"
                        data-aos-delay="200">
                    ...
                    {/* Подзаголовок */}
                    <h2 className="text-lg font-medium mb-2 text-gray-600 dark:text-gray-400 transition-colors duration-500 sm:text-xl md:text-2xl md:mb-3"
                        data-aos="fade-up"
                        data-aos-delay="300">
                        {t('hero.subtitle')}
                    </h2>
                    ...
                    {/* Описание */}
                    <p className="text-base mb-6 max-w-2xl mx-auto leading-relaxed text-gray-700 dark:text-gray-300 transition-colors duration-500 sm:text-lg md:text-xl md:mb-8 lg:mb-10 px-2 sm:px-0"
                        data-aos="fade-up"
                        data-aos-delay="600">
                        {t('hero.description')}
                    </p>
