...
export default function Wisdom() {
    ...
    useEffect(() => {
        ...
        // Перемешиваем цитаты при первом рендере
    ...
    const nextQuote = () => {
        ...
        setTimeout(() => {
            setCurrentQuoteIndex((prevIndex) =>
                prevIndex === shuffledQuotes.length - 1 ? 0 : prevIndex + 1
            );
            setFadeDirection('in');
            ...
            <div className="relative z-10 container mx-auto max-w-4xl">
                ...
                <div className="mb-12 md:mb-16" data-aos="fade-up">
                    <div className="relative">
                        ...
                        >
                            {/* Иконки цитаты */}
                            <div className="absolute top-4 md:top-6 left-4 md:left-6 text-3xl md:text-4xl text-gray-200 dark:text-gray-800">
                                "
                            </div>
                            <div className="absolute bottom-4 md:bottom-6 right-4 md:right-6 text-3xl md:text-4xl text-gray-200 dark:text-gray-800 rotate-180">
                                "
                            </div>
                        ...
                        <div className="flex items-center justify-center gap-6 mt-8">
                            <button
                                ...
                                className="p-3 rounded-full bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed shadow-sm"
                                aria-label={t('wisdom.prev', 'Предыдущая цитата')}
                            >
                            ...
                            <button
                                onClick={nextQuote}
                                disabled={isAnimating}
                                className="p-3 rounded-full bg-gray-800 dark:bg-gray-700 text-white hover:bg-gray-900 dark:hover:bg-gray-600 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed shadow-sm"
                                aria-label={t('wisdom.next', 'Следующая цитата')}
                            >
                                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
